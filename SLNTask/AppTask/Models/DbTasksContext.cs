...
public partial class DbTasksContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Codigo).HasName("PK__CentralD__06370DAD424F510D");
        ...
        {
            entity.HasKey(e => e.Codigo).HasName("PK__Departam__06370DAD5884DC68");
        ...
        {
            entity.HasKey(e => e.Codigo).HasName("PK__Funciona__06370DAD7E894C6E");
        ...
        {
            entity.HasKey(e => e.Codigo).HasName("PK__Incident__06370DAD2EA7CB04");
        ...
        {
            entity.HasKey(e => e.Codigo).HasName("PK__Tarefa__06370DADED04257B");
